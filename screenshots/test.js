...
(async () => {
  ...
  await page.goto('https://8080-fcaaecbcafccfafcbadcfecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-fcaaecbcafccfafcbadcfecdcaceefaffcabd.ide.exam.ly');
